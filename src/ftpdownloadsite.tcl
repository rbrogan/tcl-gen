...
if {[llength $::GenMissingPackages] > 0} {
     set ::GenPackageWarning "FtpDownloadSite not loaded because missing packages: $::GenMissingPackages."

     proc FtpDownloadSite {VarName Value} "error \"$::GenPackageWarning\""
